...
<form action="StudentCreateExecute.action" method="post">
	...
	<div class="d-flex flex-column mb-3">
		...
		<input class="form-control" type="text" value="${no }" id="no"  name="no" maxlength=10 placeholder="学生番号を入力してください"  required>
	</div>
	<div class="mt-2 text-warning">${errors.get("2")}</div>
	<div class="d-flex flex-column mb-3">
		<label class="form-label" for="name" >氏名</label>
		<input class="form-control" type="text" value="${name }" id="name" name="name" maxlength=10 placeholder="氏名を入力してください"  required>
	</div>
	<div class="d-flex flex-column mb-3">
